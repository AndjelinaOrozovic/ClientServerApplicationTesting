...
import java.util.*;
public class DodajStudentaBranchTest {
  ...
  @Test
  public void dodajStudentaBranch() {
    ...
    driver.findElement(By.cssSelector(".form-group:nth-child(2) > .form-control")).sendKeys("andjelina@gmail.com");
