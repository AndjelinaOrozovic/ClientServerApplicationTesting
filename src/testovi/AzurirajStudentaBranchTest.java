...
import java.util.*;
public class AzurirajStudentaBranchTest {
  ...
  @Test
  public void azurirajStudentaBranch() {
    ...
    driver.findElement(By.cssSelector(".form-group:nth-child(2) > .form-control")).sendKeys("andjelina@or.com");
    ...
    driver.findElement(By.cssSelector(".form-group:nth-child(3) > .form-control")).sendKeys("andjelina@m");
    ...
    driver.findElement(By.linkText("View Student")).click();
    driver.findElement(By.linkText("View Student")).click();
    assertThat(driver.findElement(By.cssSelector("td:nth-child(3)")).getText(), is(""
    		+ "M-Tech"));
    driver.close();
  }
}
